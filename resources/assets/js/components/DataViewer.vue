        ...
        methods:{
             ...
             buildURL(){
                ...
                if(p.search_query_1 === '' && p.search_query_2 === '' ){
                     ...
                     return String(this.source+'?column='+p.column+'&direction='+
                                             p.direction+'&per_page='+p.per_page+'&page='+p.page
                                             +'&search_operator='+p.search_operator+'&search_column='+p.search_column)
                ...
                if(p.search_query_1 !== '' && p.search_query_2 !== ''){
                        ...
                        return String(this.source+'?column='+p.column+'&direction='+
                                                                    p.direction+'&per_page='+p.per_page+'&page='+p.page
                                                                    +'&search_operator='+p.search_operator+'&search_column='+p.search_column
                                                                    +'&search_query_1='+p.search_query_1+'&search_query_2='+p.search_query_2)
