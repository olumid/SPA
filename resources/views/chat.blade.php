            ...
            <form class="form" @submit.prevent="save">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <select type="text" class="form-control" v-model="form.customer_id">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><input type="text"  v-model="form.discount"/></td>
    ...
    export default{
        ...
        computed:{
            ...
            subTotal(){
                ...
                return this.form.items.reduce(function(carry, item){
                    ...
                    return carry * parseFloat(item.qty) * parseFloat(item.qty)
        ...
        methods:{
            ...
            fetchData(){
                ...
                axios.get(String(this.initialize))
